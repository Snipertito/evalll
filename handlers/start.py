...
⋆  **اضفني الان الي مجموعتك لكي تبدا الموسيقي **
        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    ...
                    InlineKeyboardButton(
                        "☯︎GROUP☯︎", url=f"https://t.me/{GROUP_SUPPORT}"
                    ),
                    InlineKeyboardButton(
                        "𓅓CHANNEL𓅓", url=f"https://t.me/{UPDATES_CHANNEL}")               
                 ],[
                    InlineKeyboardButton(
                        "SUPPORT", url="https://t.me/Q_oo_ll"
                    )
                ]
            ]
        ),
...
- رفض إرسال رسالة إلى المساعد في الخاص.
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "SUPPORT", url=f"https://t.me/Q_oo_ll"
                    )
                ]
            ]
        )
